...
def test_implementation(user_function):
    ...
    num_timesteps = 200
    X, Y = mystery_function(A, C, Q, R, pi_0, V_0, num_timesteps)
    X_user, Y_user = user_function(A, C, Q, R, pi_0, V_0, num_timesteps)
...
def mystery_function(A, C, Q, R, pi_0, V_0, num_timesteps):
